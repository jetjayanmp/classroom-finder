    ...
    return (
      <div style={{ padding: '40px', textAlign: 'center', fontFamily: 'sans-serif' }}>
        ...
        <form onSubmit={handleLogin}>
          ...
          />
          <button type="submit" style={{ marginTop: '20px', padding: '15px 30px', backgroundColor: '#007AFF', color: 'white', border: 'none', borderRadius: '10px', fontSize: '1rem', width: '85%' }}>
            Find My Room
          </button>
        </form>
      </div>
